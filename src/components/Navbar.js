    ...
    <div>
      <div>
        <header className="p-4 flex justify-between">
          ...
          <div className="flex border border-gray-300 rounded-full px-2 py-4 gap-2 shadow-md shadow-gray-300">
            <div>Anywhere</div>
          ...
          <div className="flex border border-gray-300 rounded-full px-2 py-4 gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
